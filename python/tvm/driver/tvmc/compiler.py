...
def add_compile_parser(subparsers):
    ...
    parser.add_argument(
        ...
        "--output",
        default="module.tar",
        help="output the compiled module to a specified archive (default is module.tar).",
    )
    parser.add_argument(
        "--target",
...
def compile_model(
    ...
    package_path = tvmc_model.export_package(graph_module, package_path, cross, output_format)
